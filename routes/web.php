...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified',])->group(function () {
    ...
    Route::controller(VelzonRoutesController::class)->group(function () {
        ...
        // icons route
        Route::get("/icon/boxicons", "icons_boxicons");
        Route::get("/icon/materialdesign", "icons_materialdesign");
        Route::get("/icon/feather", "icons_feather");
        Route::get("/icon/lineawesome", "icons_lineawesome");
        Route::get("/icon/remix", "icons_remix");
        Route::get("/icon/crypto", "icons_crypto");
